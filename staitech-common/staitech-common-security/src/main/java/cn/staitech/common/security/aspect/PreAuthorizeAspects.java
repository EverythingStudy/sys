...
//@Aspect
//@Component
//public class PreAuthorizeAspects {
//
//    /**
//     * 构建
//     */
//    public PreAuthorizeAspects() {
//    }
//
//    /**
...
//            + "@annotation(cn.staitech.common.security.annotation.ProjectRequiresPermissions) || "
...
//     * 对一个Method对象进行注解检查
//     */
//    public void checkMethodAnnotation(Method method, Long projectId) {
//        // 校验 @RequiresLogin 注解
...
//            AuthUtil.checkSpecialPermi(requiresSpecialPermissions);
//        }
//
//        // 校验 @ProjectRequiresPermissions 注解
//        ProjectRequiresPermissions projectRequiresPermissions = method.getAnnotation(ProjectRequiresPermissions.class);
//        if (projectRequiresPermissions != null) {
//            AuthUtil.checkProjectPermi(projectRequiresPermissions, projectId);
//        }
//    }
//}
