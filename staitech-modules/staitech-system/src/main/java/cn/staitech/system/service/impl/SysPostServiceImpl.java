...
import cn.staitech.system.mapper.SysPostMapper;
import cn.staitech.system.mapper.SysUserPostMapper;
    ...
    public int deletePostByIds(Long[] postIds) {
        for (Long postId : postIds) {
            ...
            if (countUserPostById(postId) > 0) {
                throw new ServiceException(String.format("%1$s" + MessageSource.M("INUSE_NOT_DELETE"), post.getPostName()));
            }
        }
