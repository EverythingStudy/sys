...
import cn.staitech.system.mapper.SysDictDataMapper;
import cn.staitech.system.mapper.SysDictTypeMapper;
    ...
    public void deleteDictTypeByIds(Long[] dictIds) {
        for (Long dictId : dictIds) {
            ...
            if (dictDataMapper.countDictDataByType(dictType.getDictType()) > 0) {
                throw new ServiceException(String.format("%1$s" + MessageSource.M("INUSE_NOT_DELETE"), dictType.getDictName()));
            }
