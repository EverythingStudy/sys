...
import cn.staitech.system.mapper.SysConfigMapper;
    ...
    public void deleteConfigByIds(Long[] configIds) {
        for (Long configId : configIds) {
            ...
            if (StringUtils.equals(UserConstants.YES, config.getConfigType())) {
                throw new ServiceException(String.format(MessageSource.M("INNER_ARGUMENT") + "【%1$s】" + MessageSource.M("NOT_DELETE=NOT_DELETE"), config.getConfigKey()));
            }
